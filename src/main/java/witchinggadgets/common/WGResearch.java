...
public class WGResearch
{
	...
	public static void registerResearch()
	{
		...
		getResearchItem("AGEINGSTONE", "WITCHGADG", researchAspects, -1, -7, 2, new ItemStack(WGContent.BlockStoneDevice,1,1)).addWarp(1).setParents("WGFAKEARCANESTONE").setPages(pages).setSecondary().registerResearchItem();
		//ETHEREALWALL
		...
		getResearchItem("ENCH_SOULBOUND", "WITCHGADG", researchAspects, -10, -1, 2, new ResourceLocation("witchinggadgets:textures/gui/research/icon_ench_soulbound.png")).setParents("WGFAKEINFUSIONENCHANTMENT").setConcealed().setSecondary().setPages(pages).registerResearchItem();
