...
public class WGResearch
{
	...
	public static void registerRecipes()
	{
		...
		registerArcaneRecipe("GEMCUTTING","_TOOLS", new ItemStack(WGContent.ItemMaterial,1,8), craftingAspects,"qfi","sss", 'q',Items.quartz, 'f',Items.flint, 'i',Items.iron_ingot, 's', Items.stick);
	...
	public static void registerResearch()
	{
		...
		if (WGConfig.moduleBag) {
			...
			getResearchItem("BAGOFTRICKS", "WITCHGADG", researchAspects, 7, 2, 1, new ItemStack(WGContent.ItemBag,1,0)).setParents(new String[] { "WGFAKEENCHFABRIC", "SPINNINGWHEEL" }).setConcealed().setPages(pages).registerResearchItem();
		...
		//ORIGINAL RESEARCH
		getFakeResearchItem("RESEARCH", "BASICS", -5, -7, new ItemStack(ConfigItems.itemInkwell)).registerResearchItem();
		//ADVANCED SCRIBING TOOLS
		researchAspects = new AspectList().add(Aspect.MAGIC, 3).add(Aspect.LIGHT, 2).add(DarkAspects.GLUTTONY, 2).add(Aspect.MIND, 3);
		pages = new ResearchPage[]{
		...
		getResearchItem("ADVANCEDSCRIBINGTOOLS","WITCHGADG",researchAspects, -4, -8, 1,new ItemStack(WGContent.ItemAdvancedScribingTools)).setParents("WGFAKERESEARCH").setPages(pages).registerResearchItem();
		...
		getResearchItem("WGBAUBLES", "WITCHGADG", researchAspects, 9, -5, 1, new ItemStack(WGContent.ItemMagicalBaubles,1,2)).setParents("THAUMIUM").setPages(pages).registerResearchItem();
		...
		if (WGConfig.moduleCloak) {
			...
			if (WGConfig.moduleKama) {
				...
				getResearchItem("CLOAKKAMA", "WITCHGADG", researchAspects, 7, -5, 1, new ItemStack(WGContent.ItemKama,1,0)).setParents("WGBAUBLES","CLOAK").setConcealed().setSecondary().setPages(pages).registerResearchItem();
			}
		}
		...
		getResearchItem("STONEEXTRUDER", "WITCHGADG", researchAspects, -1, -7, 1, new ItemStack(WGContent.BlockWoodenDevice,1,2)).setParents("WGFAKEARCANESTONE","THAUMIUM").setPages(pages).registerResearchItem();

		/*
		//ICESOLIDIFIER
		researchAspects = new AspectList().add(Aspect.COLD, 1).add(Aspect.MECHANISM, 1).add(Aspect.TOOL, 1);
		pages = new ResearchPage[]{ new ResearchPage("witchinggadgets_research_page.ICESOLIDIFIER.1"), new ResearchPage((ShapedArcaneRecipe) recipeList.get("ICESOLIDIFIER")) };
		getResearchItem("ICESOLIDIFIER", "WITCHGADG", researchAspects, 1, -8, 1, new ItemStack(WGContent.BlockWoodenDevice,1,1)).setParents("STONEEXTRUDER").setPages(pages).registerResearchItem();
        */
		...
		getResearchItem("AGEINGSTONE", "WITCHGADG", researchAspects, -1, -5, 2, new ItemStack(WGContent.BlockStoneDevice,1,1)).addWarp(1).setParents("WGFAKEARCANESTONE").setPages(pages).setSecondary().registerResearchItem();
		//ETHEREALWALL
		...
		if (WGConfig.terraformer) {
			...
			getResearchItem("TERRAFORMER", "WITCHGADG", researchAspects, 6, -7, 2, new ItemStack(WGContent.BlockMetalDevice,1,2)).setPages(pages).setParents("WGFAKECENTRIFUGE").registerResearchItem();
		    ...
		    getResearchItem("TERRAFORMFOCUS_END", "WITCHGADG", researchAspects, 9, -9, 2, new ItemStack(WGContent.BlockMetalDevice,1,12)).addWarp(3).setSecondary().setPages(pages).setParents("TERRAFORMER").registerResearchItem();
			...
			getResearchItem("TERRAFORMFOCUS_MAGIC", "WITCHGADG", researchAspects, 5, -9, 2, new ItemStack(WGContent.BlockMetalDevice,1,13)).setSecondary().setPages(pages).setParents("TERRAFORMER").registerResearchItem();
		...
		if (WGConfig.modulePrimal) {
			...
			getResearchItem("PRIMORDIALGEARSET", "WITCHGADG", researchAspects, -2, 3, 3, new ResourceLocation("witchinggadgets:textures/gui/research/icon_primordialGear.png"))
			...
			getResearchItem("EMPOWERPEARL", "WITCHGADG", researchAspects, -3, 5,1, new ItemStack(WGContent.ItemMaterial,1,12))
			...
			getResearchItem("PRIMORDIALGLOVE", "WITCHGADG", researchAspects, 2, 0, 2, new ItemStack(WGContent.ItemPrimordialGlove))
			...
			getResearchItem("PRIMORDIALWEAPONRY", "WITCHGADG", researchAspects, -4, 2, 3, new ResourceLocation("witchinggadgets:textures/gui/research/icon_primordialWeaponry.png"))
			...
			getResearchItem("PRIMORDIALARMOR", "WITCHGADG", researchAspects, -1, 5, 3, new ResourceLocation("witchinggadgets:textures/gui/research/icon_primordialArmor.png"))
